...
public class GroupAdd extends JSONRoute {
    ...
    public JSONObject handleJSONRequest(JSONObject request) throws Exception {
        ...
        try {
            PreparedStatement preparedStatement = DBManager.getConnection().prepareStatement( Queries.INSERT_GROUP, Statement.RETURN_GENERATED_KEYS );
            preparedStatement.setInt( 1, request.getInt( "semesters_id" ) );
            ...
            result.put("error","Semester does not exist!" );
            return result;
        }
    }
